...
- **Interactive CLI**: Chat template support (--raw for plain completion), temperature/top-k control, thread count tuning, token ID verification mode for reproducibility
