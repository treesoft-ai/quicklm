...
OBJECTS = dist\cache\math_ops.obj dist\cache\safetensors.obj dist\cache\tokenizer.obj dist\cache\chat_template.obj dist\cache\weights.obj dist\cache\model.obj dist\cache\registry.obj dist\cache\qwen3_5.obj dist\cache\generic_transformer.obj dist\cache\main.obj dist\cache\attention.obj dist\cache\speculative.obj dist\cache\scout.obj dist\cache\sieve_convert.obj
...
HEADERS = src\tensor\tensor.hpp src\ops\math_ops.hpp src\io\json_parser.hpp src\io\safetensors.hpp src\io\tokenizer.hpp src\io\chat_template.hpp src\model\config.hpp src\model\weights.hpp src\model\modules.hpp src\model\model.hpp src\model\attention.hpp src\model\speculative.hpp src\model\scout.hpp src\model\sieve_convert.hpp src\arch\architecture.hpp src\arch\registry.hpp src\arch\qwen3_5.hpp src\arch\generic_transformer.hpp
...
dist\cache\scout.obj: src\model\scout.cpp $(HEADERS)
	if not exist dist\cache mkdir dist\cache
	$(CXX) $(CXXFLAGS) /c src\model\scout.cpp /Fodist\cache\scout.obj

dist\cache\sieve_convert.obj: src\model\sieve_convert.cpp $(HEADERS)
	if not exist dist\cache mkdir dist\cache
	$(CXX) $(CXXFLAGS) /c src\model\sieve_convert.cpp /Fodist\cache\sieve_convert.obj
